    ...
    <div>
      ...
      <div className="form" data-aos="flip-left" data-aos-duration="3000" style={{transformOrigin: '0px 0px'}}>
        ...
        <div className="social-media">
            ...
            <div className="social-icons" style={{justifyContent:'center', marginTop:'-.5rem'}}>
          ...
          <p style={{fontSize:'.7rem', paddingTop:'.8rem', marginBottom:'-.5rem'}}>Have any question or suggestion! Please let us know.</p>
        </div>
